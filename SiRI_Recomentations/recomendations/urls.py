...
from .myApi import generarRanking, apply, updateStudentVector,updateVacancyVector,getCandidateVacancies
...
urlpatterns.append(path('api/get/vacances/', getCandidateVacancies, name='getVacanciesId'))